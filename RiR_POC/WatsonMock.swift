...
class WatsonMock: NSObject {
    ...
    static func createMocks() -> [WatsonMock] {
        return [
            ...
            WatsonMock(questionText: "O que vai tocar no palco sunset hoje?", responseText: "No Palco samssét irá tocar:  Uaitisneick as 16 horas. Deseja agendar?", responseType: ResponseType.images),
            WatsonMock(questionText: "Qual o banheiro mais próximo?", responseText: "O banheiro mais próximo vazio é: Róque Stríti 1.  ", responseType: ResponseType.maps)
        ]
    }
